...
public class AuthService {
  ...
  public void register(String email, String password) { String normalized = normalize(email); if (users.existsByEmailIgnoreCase(normalized)) throw new IllegalArgumentException("An account with this email already exists."); User user = users.save(new User(normalized, passwordEncoder.encode(password))); sendOneTimeToken(user, TokenPurpose.EMAIL_VERIFICATION); }
